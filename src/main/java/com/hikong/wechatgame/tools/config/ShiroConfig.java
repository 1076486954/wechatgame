...
import com.hikong.wechatgame.tools.shiro.ShiroDbRealm;
...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager defaultWebSecurityManager(ShiroDbRealm realm){
    ...
    public ShiroDbRealm shiroDbRealm(EhCacheManager ehCacheManager){
